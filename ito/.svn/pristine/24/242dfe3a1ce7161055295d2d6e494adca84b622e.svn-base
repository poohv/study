package kr.co.kyobo.bill.baseLine.controller;
...
public class BaseLineController {
	 ...
	 * @return
	 */
	@RequestMapping("/bill/baseLine/index")
	public String indexPage(Model model) {
		return "thymeleaf/bill/baseLine/index";
	}
	 ...
	 * @return
	 */
	@RequestMapping("/bill/baseLine/list")
	public String listPage(Model model) {
		return "thymeleaf/bill/baseLine/list";
	}
	
	@ResponseBody
	@RequestMapping("/bill/baseLine/dataList")
	public Map<String, Object> findDataList(@RequestParam Map<String, Object> params) {
		Map<String, Object> resultMap = new HashMap<String, Object>();
		
		List<Map<String, Object>> dataList = baseLineService.findAll(params);
	...
	@ResponseBody
	@RequestMapping("/bill/baseLine/findOne")
	public Map<String, Object> findOne(@RequestParam Map<String, Object> params) {
		Map<String, Object> resultMap = baseLineService.findOne(params);
		
		return resultMap;
	}
	
	@ResponseBody
	@RequestMapping("/bill/baseLine/registData")
	public Map<String, Object> regist(@RequestBody Map<String, Object> params
		...
		if("N".equals(params.get("BASE_YN"))) {
			...
			resultCnt = baseLineService.findCount(baseCheckMap);
		...
		resultCnt = baseLineService.insert(params);
